	...
	public class MessagesAdapter extends ArrayAdapter<Message> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (o != null) {
				...
				if (o.getType() == Message.Type.NOT_ENOUGH_FRIENDS) {
					holder.textViewMessage.setText(getString(R.string.invite_x_friends_to_see_message, Message.MIN_FRIENDS_COUNT));
					holder.textViewMessage.setTextSize(TypedValue.COMPLEX_UNIT_PX, mResources.getDimension(R.dimen.fontsize_small));
				}
				else {
				...
				// update property images (compound drawables of TextView components)
