...
define('CONFIG_SERVER_SECRET', 'REPLACE_THIS_WITH_VALUE'); // secret used to encrypt messages before storing them in the database
...
define('CONFIG_API_PHONE_NUMBER', 'REPLACE_THIS_WITH_VALUE'); // phone number that is part of this API (e.g. for verification)
define('CONFIG_TWILIO_AUTH_CODE', 'REPLACE_THIS_WITH_VALUE'); // secret Twilio API authentication code
...
define('CONFIG_CLIENT_HASH_SEED', 'REPLACE_THIS_WITH_VALUE'); // seed used on client-side to hash phone numbers
